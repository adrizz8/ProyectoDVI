...
export default class Cafeteria extends Phaser.Scene {
    ...
    _generarCafeteriaConCaos() {
        ...
        this.enfermeraJoy = new npc(this, this.player, 976, 155, 'enfermera_joy', 0, "¿Qué hago aquí? Esto no es un Centro Pokémon... Pero bueno, ¡puedo curarte igual!", () => {
    ...
    _spawnAndres(y = 133) {
        this.andres = new npc(this, this.player, 700, y, 'npc2', 0, " ", () => {
