...
export default class prematricula_scene extends Phaser.Scene {
    ...
    create() {
        ...
        dialogM.showDialogueM(
            "Todo comenzó un lunes a las 8:00 AM." +
            "La Facultad de Informática iba a estrenar el nuevo sistema de gestión académica: \"automatrícula 2.0\". " +
